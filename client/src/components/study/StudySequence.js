...
class StudySequence extends React.Component {
    ...
    render() {
        ...
        return <Questionnaire incrementSequenceCounter={this.incrementSequenceCounter} count={this.state.count} total={this.state.tasks.length + 1} tasks={this.state.tasks} />;
    }
}
